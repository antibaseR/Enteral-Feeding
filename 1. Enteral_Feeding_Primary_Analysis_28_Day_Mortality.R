...
# Save the result
write.csv(glm_fit_df, "./Xinlei/Result/Primay_Analysis_28_Day_Mortality_glm_fit_result.csv")
...
ggsave("./Xinlei/Result/Diagnosis/Primay_Analysis_28_Day_Mortality_martingale_plot.png", width = 10, height = 5)
...
ggsave("./Xinlei/Result/Diagnosis/Primay_Analysis_28_Day_Mortality_cox_snell_plot.png", width = 8, height = 8)
...
ggsave("./Xinlei/Result/Diagnosis/Primay_Analysis_28_Day_Mortality_ph_plot.png", width = 15, height = 15)

## Testing influential observations
ggcoxdiagnostics(cox_fit, type = "deviance", sline.se = F,
                 linear.predictions = FALSE, ggtheme = theme_bw())

ggsave("./Xinlei/Result/Diagnosis/Primay_Analysis_28_Day_Mortality_deviance_plot.png", width = 8, height = 8)


# Save the result
write.csv(cox_fit_df, "./Xinlei/Result/Primay_Analysis_28_Day_Mortality_cox_fit_result.csv")
...
ggsave("./Xinlei/Result/Plot/Primary_Analysis_28-Day_Mortality_Landmark_Plot.png", width = 10, height = 8)